	...
	private void initialize() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (((i1 >= i3)&&(i1 != 25))||((i3 >= 24)&&(i1 != 25))||(flag == 1)||((i4 >= i5)&&(i4 != 25))||((i5 >= 24)&&(i4 != 25))||((i6 >= i7)&&(i6 != 25))||((i7 >= 24)&&(i6 != 25))){
		...
		JLabel lblNewLabel_12 = new JLabel("DISCLAIMER :   Enter 25 in time field for no time slot on a particular day.");
		lblNewLabel_12.setForeground(Color.RED);
		lblNewLabel_12.setBounds(10, 385, 556, 14);
